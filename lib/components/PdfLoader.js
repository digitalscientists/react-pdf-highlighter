...
var PdfLoader = function (_Component) {
  ...
  PdfLoader.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    var _this3 = this;

    if (nextProps.url && this.props.url !== nextProps.url) {
      _pdfjsDist.PDFJS.getDocument(nextProps.url).then(function (pdfDocument) {
        _this3.setState({
          pdfDocument: pdfDocument
        });
      });
